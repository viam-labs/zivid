...
int main(int argc, char** argv) {
    ...
    auto camera_reg =
        std::make_shared<viam::sdk::ModelRegistration>(viam::sdk::API::get<viam::sdk::Camera>(),
    ...
    auto discovery_reg =
        std::make_shared<viam::sdk::ModelRegistration>(viam::sdk::API::get<viam::sdk::Discovery>(),
                                                       viam::sdk::Model{"viam", "zivid", "discovery"},
                                                       [app](viam::sdk::Dependencies deps, viam::sdk::ResourceConfig cfg) {
                                                           return std::make_shared<viam_zivid::ZividDiscovery>(app, std::move(deps), cfg);
                                                       });

    auto handeye_reg = std::make_shared<viam::sdk::ModelRegistration>(viam::sdk::API::get<viam::sdk::GenericService>(),
                                                                      viam::sdk::Model{"viam", "zivid", "handeye-calibration"},
                                                                      [](viam::sdk::Dependencies deps, viam::sdk::ResourceConfig cfg) {
                                                                          return std::make_shared<viam_zivid::ZividHandEyeCalibration>(
                                                                              std::move(deps), cfg);
                                                                      });

    auto stitcher_reg =
        std::make_shared<viam::sdk::ModelRegistration>(viam::sdk::API::get<viam::sdk::GenericService>(),
                                                       viam::sdk::Model{"viam", "zivid", "stitcher"},
                                                       [](viam::sdk::Dependencies deps, viam::sdk::ResourceConfig cfg) {
                                                           return std::make_shared<viam_zivid::ZividStitcher>(std::move(deps), cfg);
                                                       });

    auto service = std::make_shared<viam::sdk::ModuleService>(
        argc, argv, std::vector<std::shared_ptr<viam::sdk::ModelRegistration>>{camera_reg, discovery_reg, handeye_reg, stitcher_reg});
